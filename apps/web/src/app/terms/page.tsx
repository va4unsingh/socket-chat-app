          ...
          <Card className="max-w-4xl mx-auto">
            ...
            <CardContent className="p-6 md:p-8 text-lg leading-relaxed text-muted-foreground">
                ...
                <section className="mb-8">
                  ...
                  <p>
                    These Terms of Service ("Terms") govern your access to and use of WhisperLink's website and services ("Service"). This is a binding agreement. By accessing or using the Service, you agree to be bound by these Terms and our <Link href="/privacy" className="text-primary hover:underline">Privacy Policy</Link>. If you do not agree to these Terms, do not use the Service.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p>
                    You must be at least 18 years old to use WhisperLink. You are responsible for your conduct and for any content you provide. You agree to use the service in compliance with our <Link href="/community-guidelines" className="text-primary hover:underline">Community Guidelines</Link> and all applicable local, state, national, and international laws.
                  </p>
                </section>
                ...
                <section className="mb-8">
                  ...
                  <p className="mb-4">
                    We offer certain enhanced features of the Services which you can purchase as a monthly or yearly subscription ("Subscription"). A description of features associated with Subscriptions is available on our <Link href="/pricing" className="text-primary hover:underline">Pricing page</Link>. When you purchase a Subscription, you must provide accurate and complete information for a valid payment method, such as a credit card, that you are authorized to use.
                  </p>
                  <h3 className="text-xl font-semibold text-foreground mb-3">b. Automatic Renewal</h3>
                  <p className="mb-4">
                    Your Subscription will automatically renew on a monthly or yearly basis. You will be billed in advance on a recurring, periodic basis. You may cancel your Subscription at any time from your account settings, but you must cancel before the renewal date to avoid being charged for the next billing cycle.
                  </p>
                  <h3 className="text-xl font-semibold text-foreground mb-3">c. Refunds</h3>
                  <p>
                    Our refund policy is detailed on our <Link href="/refund-policy" className="text-primary hover:underline">Refund Policy page</Link>. Generally, we offer a 30-day money-back guarantee for initial purchases of yearly subscriptions. Refunds are not provided for recurring monthly payments.
                  </p>
                </section>
