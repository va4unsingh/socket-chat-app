          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <motion.div variants={fadeInUp}>
                <Card className="p-8 border-border/40 shadow-lg">
                  <CardContent className="p-0">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="subject" placeholder="e.g., Billing question" required />
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="message">Message</Label>
                        <Textarea id="message" placeholder="How can we help you today?" className="min-h-[150px] resize-none" required /> {/* Fix: Added resize-none */}
                      </div>
                    ...
                    <div className="flex items-center gap-4">
                     ...
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <Link href="/faq" className="text-muted-foreground hover:text-primary">Check our FAQ page</Link>
                        </div>
                    </div>
                </div>
                <div className="pt-6">
